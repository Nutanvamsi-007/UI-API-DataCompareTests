...
public class NdtvWeatherPageCityTest extends SetupBaseWebDriver  {
	...
	void verify_city_available_on_map_with_temperature(String city) throws InterruptedException {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/cities.csv", numLinesToSkip = 1)
	void verify_clciking_city_on_map_shows_details(String city) throws InterruptedException {
		weatherPage.setCityNameOnSearchBox(city);
		assertTrue(weatherPage.getCityTempDetailsFromContainer(city).contains(city));
	}
